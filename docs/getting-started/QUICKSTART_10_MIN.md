...
不要修改本页的离线验收命令。请阅读 [`TARGET_DEVICE_OPERATION_MANUAL_ZH.md`](../target/TARGET_DEVICE_OPERATION_MANUAL_ZH.md)
和 [`P0_ADAPT_ACCEPTANCE.md`](../validation/P0_ADAPT_ACCEPTANCE.md)，完成环境、授权、只读探测和真实
