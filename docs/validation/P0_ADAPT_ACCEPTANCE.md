<!-- status: frozen; authority: normative; owner: docs maintainers; last_reviewed: 2026-08-28 -->
...
runs. Real target evidence follows [`TARGET_DEVICE_OPERATION_MANUAL_ZH.md`](../target/TARGET_DEVICE_OPERATION_MANUAL_ZH.md).
