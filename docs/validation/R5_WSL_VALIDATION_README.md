<!-- status: frozen; authority: guide; owner: docs maintainers; last_reviewed: 2026-08-28 -->

# R5 WSL 验证

> 本文冻结为 `codex/registry-redesign-r5` 分支快照的验证说明，不是当前默认分支的
> Registry 基线。当前产品语义和契约以 [Registry Operation 指南](../operations/REGISTRY_OPERATION_GUIDE.md)
> 及生成清单为准。
