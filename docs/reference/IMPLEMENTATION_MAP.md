...
| Diagnose/Verify contract、fake、handoff 与 P1 adapter 边界 | `test_diagnosis_contract.py`、`test_verify_evidence_contract.py`、`test_legacy_provider_adapter.py`、`test_post_r5_provider_boundary.py`、`test_fake_downstream.py`、`test_handoff_materializers.py` |
