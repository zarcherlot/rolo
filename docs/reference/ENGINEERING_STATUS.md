<!-- status: active; authority: reference; owner: ROLO maintainers; last_reviewed: 2026-08-29; last_synced_commit: 9266c940f717f087df067f1246f1d8d4cdf029c3 -->
...
| FEAT-VERIFY-CONTRACT | PARTIAL | E3 | Verify plan、acceptance plan、evidence 和 replay | `src/rolo/stages/verify/service.py`; `src/rolo/stages/verify/acceptance.py`; `src/rolo/stages/real_target.py` | `tests/test_verification_acceptance.py`; `tests/test_handoff_materializers.py`; `tests/test_real_target_contracts.py` | 固定只读 Linux/ROS case 可执行；物理机器人和通用 acceptance oracle 仍是扩展点 |
