...
sections. This narrative polish is separate from the evidence/unknown review Agent. Missing
credentials, model failure, timeout, or invalid output automatically falls back
