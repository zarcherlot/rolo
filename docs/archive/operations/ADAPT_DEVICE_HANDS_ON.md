...
[`Rolo 目标机部署与 Adapt 操作手册`](../../target/TARGET_DEVICE_OPERATION_MANUAL_ZH.md).
...
[`TARGET_EVIDENCE_DEPLOYMENT.md`](../../target/TARGET_EVIDENCE_DEPLOYMENT.md), then run the same command with
