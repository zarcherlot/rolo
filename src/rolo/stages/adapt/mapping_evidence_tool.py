...
The provider copies this file and a frozen request into its read-only
workspace. It performs no discovery and executes no target code: every answer
is a deterministic projection of evidence already collected by Rolo.
"""
...
def evaluate(
    ...
    *,
    ...
    facts = {
        ...
        "RUNTIME_REVISION_KNOWN": bool(
            binding_match and route and route.get("runtime_revision")
        ),
    }
    result = {
        "operation": operation,
